...
public class PagingUtil {
	...
	public static String pagingHomepy(int totalRecordCount, int pageSize, int blockPage, int nowPage, String pageName) {
	...
	public static String pagingImgServlet(int totalRecordCount, int pageSize, int blockPage, int nowPage, String pageName) {
