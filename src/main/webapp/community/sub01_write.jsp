		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<!-- 내용 삽입 s -->
					...
					<tbody>
					<form name="writeFrm" method="post" action="<c:url value="/Community/CommWrite.sua" />"
						onsubmit="return frmValidate(this);" enctype="multipart/form-data">
					...
					<div class="row mb-3">
						<div class="col text-right">		
							...
							<button type="button" class="btn btn-warning" onclick="location.href='../Community/CommList.sua';">리스트보기</button>
						</div>
					</form>
					</div>	
				<!-- 내용 삽입 e -->
