...
<div id="top" style="border:0px solid #000;"> 
	<% if(request.getRequestURL().indexOf("servlet")==-1){ %>
		<a href="../main/main.jsp"><img src="../images/logo.gif" alt="마포구립장애인 직업재활센터" id="top_logo" /></a>
	<% } else { %> 
		<div style="border:0px solid red;padding:35px 0 0 30px;width: 150px;font-weight: bold;color: black;">
			<a href="../main/main.do"><span style="font-size: 2.5em;">Servlet</span></a>
		</div>
	<% } %>
	<ul id="lnb">
	<%
	...
	<map name="GNB">
		...
		<area shape="rect" alt="" title="" coords="536,0,638,33" href="../Community/CommList.sua" target="" /><!-- ../community/sub01.jsp -->
